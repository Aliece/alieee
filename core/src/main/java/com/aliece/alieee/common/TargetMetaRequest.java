...
public class TargetMetaRequest implements Serializable {
    ...
    /**
     *  ComponentVisitor is HttpSessionComponentVisitor created in {@link UserTargetMetaDefFactory#createTargetMetaRequest(TargetMetaDef, com.aliece.alieee.controller.context.ContextHolder)}
     * 
     * @param targetMetaDef
     */
     ...
     * set vistable value be com.aliece.alieee.bussinessproxy.target.TargetServiceFactoryVisitable
     * 
     ...
     * set vistable value be  com.aliece.alieee.bussinessproxy.dyncproxy.ProxyInstanceFactoryVisitable
     * 
