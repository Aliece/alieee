 ...
 * 
 */
package com.aliece.alieee.async.future;

import com.aliece.alieee.async.EventResultHandler;
...
public class EventResultFuture implements EventResultHandler {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.aliece.alieee.async.message.EventMessageHolder#getEventResult()
	 */
	public Object get() {
		Object result = null;
		if (over)
